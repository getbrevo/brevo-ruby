...
# Unit tests for BrevoApiV3Sdk::CreateUpdateCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUpdateCategory' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateUpdateCategory.new
  end
  ...
  describe 'test an instance of CreateUpdateCategory' do
    it 'should create an instance of CreateUpdateCategory' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateUpdateCategory)
    end
  end
