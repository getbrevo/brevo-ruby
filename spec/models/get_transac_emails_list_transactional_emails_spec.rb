...
# Unit tests for BrevoApiV3Sdk::GetTransacEmailsListTransactionalEmails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacEmailsListTransactionalEmails' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacEmailsListTransactionalEmails.new
  end
  ...
  describe 'test an instance of GetTransacEmailsListTransactionalEmails' do
    it 'should create an instance of GetTransacEmailsListTransactionalEmails' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacEmailsListTransactionalEmails)
    end
  end
