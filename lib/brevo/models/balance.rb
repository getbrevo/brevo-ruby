...
module Brevo
  class Balance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consumedAt')
        self.consumed_at = attributes[:'consumedAt']
      end
    ...
    def hash
      [amount, balance_definition_id, consumed_at, contact_id, created_at, expires_at, id, loyalty_program_id, organization_id].hash
    end
