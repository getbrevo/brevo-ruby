...
# Unit tests for BrevoApiV3Sdk::GetTransacEmailContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacEmailContent' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacEmailContent.new
  end
  ...
  describe 'test an instance of GetTransacEmailContent' do
    it 'should create an instance of GetTransacEmailContent' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacEmailContent)
    end
  end
