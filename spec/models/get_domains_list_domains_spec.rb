...
# Unit tests for BrevoApiV3Sdk::GetDomainsListDomains
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDomainsListDomains' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetDomainsListDomains.new
  end
  ...
  describe 'test an instance of GetDomainsListDomains' do
    it 'should create an instance of GetDomainsListDomains' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetDomainsListDomains)
    end
  end
