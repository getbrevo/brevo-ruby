...
# Unit tests for BrevoApiV3Sdk::TransactionalWhatsAppApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionalWhatsAppApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::TransactionalWhatsAppApi.new
  end
  ...
  describe 'test an instance of TransactionalWhatsAppApi' do
    it 'should create an instance of TransactionalWhatsAppApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::TransactionalWhatsAppApi)
    end
  end
