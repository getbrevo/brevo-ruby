...
module Brevo
  class TemplatePreview
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'usedFeedNames')
        if (value = attributes[:'usedFeedNames']).is_a?(Array)
          self.used_feed_names = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          html == o.html &&
          subject == o.subject &&
          used_feed_names == o.used_feed_names &&
    ...
    def hash
      [from_email, from_name, html, subject, used_feed_names, preview_text].hash
    end
