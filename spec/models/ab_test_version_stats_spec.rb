...
# Unit tests for BrevoApiV3Sdk::AbTestVersionStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbTestVersionStats' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AbTestVersionStats.new
  end
  ...
  describe 'test an instance of AbTestVersionStats' do
    it 'should create an instance of AbTestVersionStats' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AbTestVersionStats)
    end
  end
