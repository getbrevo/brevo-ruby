...
require 'brevo/models/add_subscription_member_payload'
require 'brevo/models/aggregate_balance'
require 'brevo/models/authenticate_domain_model'
require 'brevo/models/balance'
require 'brevo/models/balance_data_per_contact'
require 'brevo/models/balance_definition'
require 'brevo/models/balance_definition_page'
require 'brevo/models/balance_limit'
require 'brevo/models/balance_order'
...
require 'brevo/models/body_16'
require 'brevo/models/body_17'
require 'brevo/models/body_18'
require 'brevo/models/body_19'
...
require 'brevo/models/contact_balances_resp'
require 'brevo/models/contact_error_model'
require 'brevo/models/conversations_message'
require 'brevo/models/conversations_message_attachments'
require 'brevo/models/conversations_message_file'
require 'brevo/models/conversations_message_file_image_info'
require 'brevo/models/conversations_message_forwarded_to_source_status'
require 'brevo/models/conversations_message_from'
require 'brevo/models/conversations_message_reply_to'
require 'brevo/models/conversations_message_to'
...
require 'brevo/models/corporateuseremailpermissions_privileges'
...
require 'brevo/models/create_balance_definition_payload'
require 'brevo/models/create_balance_limit_payload'
require 'brevo/models/create_balance_payload'
...
require 'brevo/models/create_email_campaign_email_expiration_date'
...
require 'brevo/models/create_loyalty_program_payload'
require 'brevo/models/create_model'
require 'brevo/models/create_order_payload'
...
require 'brevo/models/create_subscription_payload'
require 'brevo/models/create_subscription_response'
require 'brevo/models/create_tier_group_request'
require 'brevo/models/create_transaction_payload'
...
require 'brevo/models/get_segment'
...
require 'brevo/models/inline_response_200_4'
require 'brevo/models/inline_response_200_5'
require 'brevo/models/inline_response_200_6'
require 'brevo/models/inline_response_200_6_totals'
require 'brevo/models/inline_response_200_7'
require 'brevo/models/inline_response_200_8'
require 'brevo/models/inline_response_200_9'
...
require 'brevo/models/inline_response_400'
...
require 'brevo/models/loyalty_program'
require 'brevo/models/loyalty_program_page'
require 'brevo/models/loyalty_program_validation_error'
require 'brevo/models/loyalty_tier_page'
require 'brevo/models/main_attribute_reward_payload'
require 'brevo/models/main_billing_payload'
require 'brevo/models/main_code_count_http_response'
require 'brevo/models/main_create_redeem_payload'
require 'brevo/models/main_create_redeem_payload_order'
require 'brevo/models/main_create_reward_payload'
require 'brevo/models/main_create_reward_response'
require 'brevo/models/main_error_response'
require 'brevo/models/main_filter'
require 'brevo/models/main_generator'
require 'brevo/models/main_get_contact_rewards_payload'
require 'brevo/models/main_identifiers_payload'
require 'brevo/models/main_limit'
require 'brevo/models/main_model_contact_reward'
require 'brevo/models/main_model_contact_rewards_resp'
require 'brevo/models/main_node_response'
require 'brevo/models/main_order_payload'
require 'brevo/models/main_order_payload_billing'
require 'brevo/models/main_order_payload_identifiers'
require 'brevo/models/main_product'
require 'brevo/models/main_product_payload'
require 'brevo/models/main_redeem'
require 'brevo/models/main_result_parameter_response'
require 'brevo/models/main_result_parameter_response_value'
require 'brevo/models/main_reward'
require 'brevo/models/main_reward_attribution'
require 'brevo/models/main_reward_configurations'
require 'brevo/models/main_reward_generator'
require 'brevo/models/main_reward_page'
require 'brevo/models/main_reward_page_obj'
require 'brevo/models/main_reward_rule'
require 'brevo/models/main_reward_validate'
require 'brevo/models/main_rule'
require 'brevo/models/main_rule_condition'
require 'brevo/models/main_rule_condition_response'
require 'brevo/models/main_rule_condition_response_lhs'
require 'brevo/models/main_rule_condition_response_rhs'
require 'brevo/models/main_rule_event'
require 'brevo/models/main_rule_event_response'
require 'brevo/models/main_rule_result_response'
require 'brevo/models/main_validate_reward_payload'
require 'brevo/models/main_value_response'
require 'brevo/models/main_value_response_expression'
require 'brevo/models/main_voucher_revoke_payload'
...
require 'brevo/models/member_contact'
require 'brevo/models/model_subscription_balance_resp'
...
require 'brevo/models/order_identifiers'
require 'brevo/models/order_products'
require 'brevo/models/otp'
require 'brevo/models/patch_loyalty_program_payload'
...
require 'brevo/models/send_transac_sms_tag'
require 'brevo/models/send_whatsapp_message'
require 'brevo/models/set_config_display_currency'
...
require 'brevo/models/sub_account_details_response_groups'
...
require 'brevo/models/sub_account_details_response_plan_info_credits_external_feeds'
require 'brevo/models/sub_account_details_response_plan_info_credits_sms'
require 'brevo/models/sub_account_details_response_plan_info_credits_whatsapp'
...
require 'brevo/models/sub_account_details_response_plan_info_features_sales_users'
...
require 'brevo/models/sub_accounts_response_groups'
require 'brevo/models/sub_accounts_response_sub_accounts'
require 'brevo/models/sub_accounts_update_plan_request'
require 'brevo/models/sub_accounts_update_plan_request_credits'
require 'brevo/models/sub_accounts_update_plan_request_features'
require 'brevo/models/subscription'
require 'brevo/models/subscription_aggregate_balance'
require 'brevo/models/subscription_attributed_reward'
require 'brevo/models/subscription_balances'
require 'brevo/models/subscription_handler_info'
require 'brevo/models/subscription_handler_info_balance'
require 'brevo/models/subscription_member'
require 'brevo/models/subscription_tier'
require 'brevo/models/task'
require 'brevo/models/task_list'
require 'brevo/models/task_reminder'
require 'brevo/models/task_types'
require 'brevo/models/template_preview'
require 'brevo/models/tier'
require 'brevo/models/tier_access_conditions'
require 'brevo/models/tier_for_contact'
require 'brevo/models/tier_group'
require 'brevo/models/tier_group_page'
require 'brevo/models/tier_request'
require 'brevo/models/tier_request_access_conditions'
require 'brevo/models/tier_request_put_payload'
require 'brevo/models/tier_request_tier_rewards'
require 'brevo/models/tier_tier_rewards'
require 'brevo/models/transaction'
require 'brevo/models/transaction_history'
require 'brevo/models/transaction_history_resp'
require 'brevo/models/unauthorized_response'
require 'brevo/models/update_attribute'
require 'brevo/models/update_attribute_enumeration'
require 'brevo/models/update_balance_definition_payload'
require 'brevo/models/update_balance_limit_payload'
...
require 'brevo/models/update_email_campaign_email_expiration_date'
...
require 'brevo/models/update_loyalty_program_payload'
...
require 'brevo/models/update_tier_group_request'
...
require 'brevo/models/validation_errors'
