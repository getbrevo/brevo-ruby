...
# Unit tests for BrevoApiV3Sdk::GetContactCampaignStatsUnsubscriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsUnsubscriptions' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetContactCampaignStatsUnsubscriptions.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsUnsubscriptions' do
    it 'should create an instance of GetContactCampaignStatsUnsubscriptions' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetContactCampaignStatsUnsubscriptions)
    end
  end
