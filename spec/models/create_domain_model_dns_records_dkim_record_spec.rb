...
# Unit tests for BrevoApiV3Sdk::CreateDomainModelDnsRecordsDkimRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDomainModelDnsRecordsDkimRecord' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateDomainModelDnsRecordsDkimRecord.new
  end
  ...
  describe 'test an instance of CreateDomainModelDnsRecordsDkimRecord' do
    it 'should create an instance of CreateDomainModelDnsRecordsDkimRecord' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateDomainModelDnsRecordsDkimRecord)
    end
  end
