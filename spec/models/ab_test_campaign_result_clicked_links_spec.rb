...
# Unit tests for BrevoApiV3Sdk::AbTestCampaignResultClickedLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbTestCampaignResultClickedLinks' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AbTestCampaignResultClickedLinks.new
  end
  ...
  describe 'test an instance of AbTestCampaignResultClickedLinks' do
    it 'should create an instance of AbTestCampaignResultClickedLinks' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AbTestCampaignResultClickedLinks)
    end
  end
