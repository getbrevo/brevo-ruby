...
# Unit tests for BrevoApiV3Sdk::AbTestVersionClicksInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbTestVersionClicksInner' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AbTestVersionClicksInner.new
  end
  ...
  describe 'test an instance of AbTestVersionClicksInner' do
    it 'should create an instance of AbTestVersionClicksInner' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AbTestVersionClicksInner)
    end
  end
