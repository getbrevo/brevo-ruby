...
module Brevo
  ...
  class TransactionHistoryResp
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transactionHistory')
        if (value = attributes[:'transactionHistory']).is_a?(Array)
    ...
    def hash
      [balance_definition_id, contact_id, count, loyalty_program_id, transaction_history].hash
    end
