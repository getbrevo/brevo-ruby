...
# Unit tests for BrevoApiV3Sdk::ScheduleSmtpEmail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduleSmtpEmail' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::ScheduleSmtpEmail.new
  end
  ...
  describe 'test an instance of ScheduleSmtpEmail' do
    it 'should create an instance of ScheduleSmtpEmail' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::ScheduleSmtpEmail)
    end
  end
