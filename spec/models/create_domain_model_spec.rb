...
# Unit tests for BrevoApiV3Sdk::CreateDomainModel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDomainModel' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateDomainModel.new
  end
  ...
  describe 'test an instance of CreateDomainModel' do
    it 'should create an instance of CreateDomainModel' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateDomainModel)
    end
  end
