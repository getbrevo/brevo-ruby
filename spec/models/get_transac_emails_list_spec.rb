...
# Unit tests for BrevoApiV3Sdk::GetTransacEmailsList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacEmailsList' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacEmailsList.new
  end
  ...
  describe 'test an instance of GetTransacEmailsList' do
    it 'should create an instance of GetTransacEmailsList' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacEmailsList)
    end
  end
