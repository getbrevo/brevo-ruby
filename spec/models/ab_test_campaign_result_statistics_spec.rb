...
# Unit tests for BrevoApiV3Sdk::AbTestCampaignResultStatistics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbTestCampaignResultStatistics' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AbTestCampaignResultStatistics.new
  end
  ...
  describe 'test an instance of AbTestCampaignResultStatistics' do
    it 'should create an instance of AbTestCampaignResultStatistics' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AbTestCampaignResultStatistics)
    end
  end
