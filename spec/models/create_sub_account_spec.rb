...
# Unit tests for BrevoApiV3Sdk::CreateSubAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubAccount' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateSubAccount.new
  end
  ...
  describe 'test an instance of CreateSubAccount' do
    it 'should create an instance of CreateSubAccount' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateSubAccount)
    end
  end
