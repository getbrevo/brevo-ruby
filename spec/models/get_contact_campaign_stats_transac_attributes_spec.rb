...
# Unit tests for BrevoApiV3Sdk::GetContactCampaignStatsTransacAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsTransacAttributes' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetContactCampaignStatsTransacAttributes.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsTransacAttributes' do
    it 'should create an instance of GetContactCampaignStatsTransacAttributes' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetContactCampaignStatsTransacAttributes)
    end
  end
