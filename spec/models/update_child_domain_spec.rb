...
# Unit tests for BrevoApiV3Sdk::UpdateChildDomain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateChildDomain' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateChildDomain.new
  end
  ...
  describe 'test an instance of UpdateChildDomain' do
    it 'should create an instance of UpdateChildDomain' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateChildDomain)
    end
  end
