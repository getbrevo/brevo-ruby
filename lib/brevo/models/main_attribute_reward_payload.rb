...
module Brevo
  class MainAttributeRewardPayload
    ...
    def list_invalid_properties
      ...
      if !@code.nil? && @code.to_s.length > 128
    ...
    def valid?
      return false if !@code.nil? && @code.to_s.length > 128
    ...
    def hash
      [value, code, contact_id, expiration_date, loyalty_subscription_id, meta, reward_id].hash
    end
