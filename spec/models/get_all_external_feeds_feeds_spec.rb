...
# Unit tests for BrevoApiV3Sdk::GetAllExternalFeedsFeeds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAllExternalFeedsFeeds' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetAllExternalFeedsFeeds.new
  end
  ...
  describe 'test an instance of GetAllExternalFeedsFeeds' do
    it 'should create an instance of GetAllExternalFeedsFeeds' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetAllExternalFeedsFeeds)
    end
  end
