...
# Unit tests for BrevoApiV3Sdk::CreateUpdateBatchProducts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUpdateBatchProducts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateUpdateBatchProducts.new
  end
  ...
  describe 'test an instance of CreateUpdateBatchProducts' do
    it 'should create an instance of CreateUpdateBatchProducts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateUpdateBatchProducts)
    end
  end
