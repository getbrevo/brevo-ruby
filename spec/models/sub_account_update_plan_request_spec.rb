...
# Unit tests for BrevoApiV3Sdk::SubAccountUpdatePlanRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountUpdatePlanRequest' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::SubAccountUpdatePlanRequest.new
  end
  ...
  describe 'test an instance of SubAccountUpdatePlanRequest' do
    it 'should create an instance of SubAccountUpdatePlanRequest' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::SubAccountUpdatePlanRequest)
    end
  end
