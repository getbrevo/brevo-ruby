...
# Unit tests for BrevoApiV3Sdk::GetContactCampaignStatsOpened
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsOpened' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetContactCampaignStatsOpened.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsOpened' do
    it 'should create an instance of GetContactCampaignStatsOpened' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetContactCampaignStatsOpened)
    end
  end
