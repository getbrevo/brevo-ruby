...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription)
    end
  end
