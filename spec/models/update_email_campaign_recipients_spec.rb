...
# Unit tests for BrevoApiV3Sdk::UpdateEmailCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateEmailCampaignRecipients' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateEmailCampaignRecipients.new
  end
  ...
  describe 'test an instance of UpdateEmailCampaignRecipients' do
    it 'should create an instance of UpdateEmailCampaignRecipients' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateEmailCampaignRecipients)
    end
  end
