...
# Unit tests for BrevoApiV3Sdk::RemainingCreditModelChild
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemainingCreditModelChild' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::RemainingCreditModelChild.new
  end
  ...
  describe 'test an instance of RemainingCreditModelChild' do
    it 'should create an instance of RemainingCreditModelChild' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::RemainingCreditModelChild)
    end
  end
