...
# Unit tests for BrevoApiV3Sdk::RequestContactExportCustomContactFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestContactExportCustomContactFilter' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::RequestContactExportCustomContactFilter.new
  end
  ...
  describe 'test an instance of RequestContactExportCustomContactFilter' do
    it 'should create an instance of RequestContactExportCustomContactFilter' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::RequestContactExportCustomContactFilter)
    end
  end
