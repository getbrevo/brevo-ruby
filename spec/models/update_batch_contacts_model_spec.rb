...
# Unit tests for BrevoApiV3Sdk::UpdateBatchContactsModel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateBatchContactsModel' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateBatchContactsModel.new
  end
  ...
  describe 'test an instance of UpdateBatchContactsModel' do
    it 'should create an instance of UpdateBatchContactsModel' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateBatchContactsModel)
    end
  end
