...
# Unit tests for Brevo::UpdateBalanceLimitPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateBalanceLimitPayload' do
  before do
    # run before each test
    @instance = Brevo::UpdateBalanceLimitPayload.new
  end
  ...
  describe 'test an instance of UpdateBalanceLimitPayload' do
    it 'should create an instance of UpdateBalanceLimitPayload' do
      expect(@instance).to be_instance_of(Brevo::UpdateBalanceLimitPayload)
    end
  end
  describe 'test attribute "constraint_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["transaction", "amount"])
  ...
  describe 'test attribute "sliding_schedule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
