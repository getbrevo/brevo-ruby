...
# Unit tests for BrevoApiV3Sdk::GetIpsFromSender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetIpsFromSender' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetIpsFromSender.new
  end
  ...
  describe 'test an instance of GetIpsFromSender' do
    it 'should create an instance of GetIpsFromSender' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetIpsFromSender)
    end
  end
