...
# Unit tests for BrevoApiV3Sdk::GetCategoryDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCategoryDetails' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetCategoryDetails.new
  end
  ...
  describe 'test an instance of GetCategoryDetails' do
    it 'should create an instance of GetCategoryDetails' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetCategoryDetails)
    end
  end
