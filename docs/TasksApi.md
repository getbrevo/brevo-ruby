...
api_instance = BrevoApiV3Sdk::TasksApi.new
...
body = BrevoApiV3Sdk::Body7.new # Body7 | Updated task details.
...
body = BrevoApiV3Sdk::Body6.new # Body6 | Task name.
