...
# Unit tests for BrevoApiV3Sdk::UpdateChildAccountStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateChildAccountStatus' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateChildAccountStatus.new
  end
  ...
  describe 'test an instance of UpdateChildAccountStatus' do
    it 'should create an instance of UpdateChildAccountStatus' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateChildAccountStatus)
    end
  end
