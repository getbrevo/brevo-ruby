...
# Unit tests for BrevoApiV3Sdk::GetExtendedClient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedClient' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedClient.new
  end
  ...
  describe 'test an instance of GetExtendedClient' do
    it 'should create an instance of GetExtendedClient' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedClient)
    end
  end
