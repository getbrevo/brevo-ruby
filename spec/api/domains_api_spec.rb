...
# Unit tests for BrevoApiV3Sdk::DomainsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DomainsApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::DomainsApi.new
  end
  ...
  describe 'test an instance of DomainsApi' do
    it 'should create an instance of DomainsApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::DomainsApi)
    end
  end
  ...
  # unit tests for get_domainonfiguration
  # Validate domain configuration
  # @param domain_name Domain name
  # @param [Hash] opts the optional parameters
  # @return [GetDomainonfigurationModel]
  describe 'get_domainonfiguration test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
