...
# Unit tests for BrevoApiV3Sdk::GetWhatsappEventReportEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWhatsappEventReportEvents' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetWhatsappEventReportEvents.new
  end
  ...
  describe 'test an instance of GetWhatsappEventReportEvents' do
    it 'should create an instance of GetWhatsappEventReportEvents' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetWhatsappEventReportEvents)
    end
  end
