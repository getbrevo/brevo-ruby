...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsUnsubscriptions' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptions.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsUnsubscriptions' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptions' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptions)
    end
  end
