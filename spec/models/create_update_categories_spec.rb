...
# Unit tests for BrevoApiV3Sdk::CreateUpdateCategories
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUpdateCategories' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateUpdateCategories.new
  end
  ...
  describe 'test an instance of CreateUpdateCategories' do
    it 'should create an instance of CreateUpdateCategories' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateUpdateCategories)
    end
  end
