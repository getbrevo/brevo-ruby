...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatistics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatistics' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatistics.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatistics' do
    it 'should create an instance of GetExtendedContactDetailsStatistics' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatistics)
    end
  end
