...
# Unit tests for BrevoApiV3Sdk::GetWhatsappCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWhatsappCampaignOverview' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetWhatsappCampaignOverview.new
  end
  ...
  describe 'test an instance of GetWhatsappCampaignOverview' do
    it 'should create an instance of GetWhatsappCampaignOverview' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetWhatsappCampaignOverview)
    end
  end
