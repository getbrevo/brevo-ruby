...
# Unit tests for BrevoApiV3Sdk::GetEmailCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailCampaign' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetEmailCampaign.new
  end
  ...
  describe 'test an instance of GetEmailCampaign' do
    it 'should create an instance of GetEmailCampaign' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetEmailCampaign)
    end
  end
