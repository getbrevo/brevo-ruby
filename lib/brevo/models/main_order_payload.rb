...
module Brevo
  class MainOrderPayload
    ...
    def self.swagger_types
      {
        :'amount' => :'Float',
        :'billing' => :'MainOrderPayloadBilling',
        :'contact_id' => :'Integer',
        :'coupons' => :'Array<String>',
        :'created_at' => :'DateTime',
        :'email' => :'String',
        :'id' => :'String',
        :'identifiers' => :'MainOrderPayloadIdentifiers',
    ...
    def hash
      [amount, billing, contact_id, coupons, created_at, email, id, identifiers, products, status, store_id, updated_at].hash
    end
