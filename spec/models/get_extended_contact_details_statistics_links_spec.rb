...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsLinks' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsLinks.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsLinks' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsLinks' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsLinks)
    end
  end
