...
# Unit tests for BrevoApiV3Sdk::EmailCampaignsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailCampaignsApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::EmailCampaignsApi.new
  end
  ...
  describe 'test an instance of EmailCampaignsApi' do
    it 'should create an instance of EmailCampaignsApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::EmailCampaignsApi)
    end
  end
