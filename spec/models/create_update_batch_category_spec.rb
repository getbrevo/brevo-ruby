...
# Unit tests for BrevoApiV3Sdk::CreateUpdateBatchCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUpdateBatchCategory' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateUpdateBatchCategory.new
  end
  ...
  describe 'test an instance of CreateUpdateBatchCategory' do
    it 'should create an instance of CreateUpdateBatchCategory' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateUpdateBatchCategory)
    end
  end
