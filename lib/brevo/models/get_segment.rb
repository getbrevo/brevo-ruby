...
module Brevo
  class GetSegment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'segmentName')
        self.segment_name = attributes[:'segmentName']
      end
    ...
    def list_invalid_properties
      ...
      if @segment_name.nil?
        invalid_properties.push('invalid value for "segment_name", segment_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @segment_name.nil?
