...
# Unit tests for BrevoApiV3Sdk::CreateWhatsAppCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateWhatsAppCampaign' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateWhatsAppCampaign.new
  end
  ...
  describe 'test an instance of CreateWhatsAppCampaign' do
    it 'should create an instance of CreateWhatsAppCampaign' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateWhatsAppCampaign)
    end
  end
