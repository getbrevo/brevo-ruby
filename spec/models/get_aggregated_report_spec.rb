...
# Unit tests for BrevoApiV3Sdk::GetAggregatedReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAggregatedReport' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetAggregatedReport.new
  end
  ...
  describe 'test an instance of GetAggregatedReport' do
    it 'should create an instance of GetAggregatedReport' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetAggregatedReport)
    end
  end
