...
# Unit tests for BrevoApiV3Sdk::MasterAccountApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterAccountApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::MasterAccountApi.new
  end
  ...
  describe 'test an instance of MasterAccountApi' do
    it 'should create an instance of MasterAccountApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::MasterAccountApi)
    end
  end
