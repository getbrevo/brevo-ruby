...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetails' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetails.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetails' do
    it 'should create an instance of GetExtendedContactDetails' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetails)
    end
  end
