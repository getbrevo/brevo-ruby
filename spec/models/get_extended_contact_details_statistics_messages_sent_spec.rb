...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsMessagesSent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsMessagesSent' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsMessagesSent.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsMessagesSent' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsMessagesSent' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsMessagesSent)
    end
  end
