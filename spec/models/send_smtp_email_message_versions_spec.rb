...
# Unit tests for BrevoApiV3Sdk::SendSmtpEmailMessageVersions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendSmtpEmailMessageVersions' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::SendSmtpEmailMessageVersions.new
  end
  ...
  describe 'test an instance of SendSmtpEmailMessageVersions' do
    it 'should create an instance of SendSmtpEmailMessageVersions' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::SendSmtpEmailMessageVersions)
    end
  end
