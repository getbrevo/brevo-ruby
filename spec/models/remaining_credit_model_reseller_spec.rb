...
# Unit tests for BrevoApiV3Sdk::RemainingCreditModelReseller
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemainingCreditModelReseller' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::RemainingCreditModelReseller.new
  end
  ...
  describe 'test an instance of RemainingCreditModelReseller' do
    it 'should create an instance of RemainingCreditModelReseller' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::RemainingCreditModelReseller)
    end
  end
