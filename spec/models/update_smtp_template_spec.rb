...
# Unit tests for BrevoApiV3Sdk::UpdateSmtpTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSmtpTemplate' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateSmtpTemplate.new
  end
  ...
  describe 'test an instance of UpdateSmtpTemplate' do
    it 'should create an instance of UpdateSmtpTemplate' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateSmtpTemplate)
    end
  end
