...
# Unit tests for BrevoApiV3Sdk::GetBlockedDomains
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetBlockedDomains' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetBlockedDomains.new
  end
  ...
  describe 'test an instance of GetBlockedDomains' do
    it 'should create an instance of GetBlockedDomains' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetBlockedDomains)
    end
  end
