...
# Unit tests for BrevoApiV3Sdk::GetExternalFeedByUUID
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExternalFeedByUUID' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExternalFeedByUUID.new
  end
  ...
  describe 'test an instance of GetExternalFeedByUUID' do
    it 'should create an instance of GetExternalFeedByUUID' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExternalFeedByUUID)
    end
  end
