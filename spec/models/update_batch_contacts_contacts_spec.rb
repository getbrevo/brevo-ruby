...
# Unit tests for BrevoApiV3Sdk::UpdateBatchContactsContacts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateBatchContactsContacts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateBatchContactsContacts.new
  end
  ...
  describe 'test an instance of UpdateBatchContactsContacts' do
    it 'should create an instance of UpdateBatchContactsContacts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateBatchContactsContacts)
    end
  end
