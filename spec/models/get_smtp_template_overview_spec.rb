...
# Unit tests for BrevoApiV3Sdk::GetSmtpTemplateOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmtpTemplateOverview' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetSmtpTemplateOverview.new
  end
  ...
  describe 'test an instance of GetSmtpTemplateOverview' do
    it 'should create an instance of GetSmtpTemplateOverview' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetSmtpTemplateOverview)
    end
  end
