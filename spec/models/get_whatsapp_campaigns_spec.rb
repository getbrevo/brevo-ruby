...
# Unit tests for BrevoApiV3Sdk::GetWhatsappCampaigns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWhatsappCampaigns' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetWhatsappCampaigns.new
  end
  ...
  describe 'test an instance of GetWhatsappCampaigns' do
    it 'should create an instance of GetWhatsappCampaigns' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetWhatsappCampaigns)
    end
  end
