...
# Unit tests for BrevoApiV3Sdk::CreateDoiContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDoiContact' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateDoiContact.new
  end
  ...
  describe 'test an instance of CreateDoiContact' do
    it 'should create an instance of CreateDoiContact' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateDoiContact)
    end
  end
