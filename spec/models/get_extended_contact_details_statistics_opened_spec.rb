...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsOpened
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsOpened' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsOpened.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsOpened' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsOpened' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsOpened)
    end
  end
