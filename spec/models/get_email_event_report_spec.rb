...
# Unit tests for BrevoApiV3Sdk::GetEmailEventReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailEventReport' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetEmailEventReport.new
  end
  ...
  describe 'test an instance of GetEmailEventReport' do
    it 'should create an instance of GetEmailEventReport' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetEmailEventReport)
    end
  end
