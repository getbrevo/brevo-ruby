...
# Unit tests for BrevoApiV3Sdk::AuthenticateDomainModel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticateDomainModel' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AuthenticateDomainModel.new
  end
  ...
  describe 'test an instance of AuthenticateDomainModel' do
    it 'should create an instance of AuthenticateDomainModel' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AuthenticateDomainModel)
    end
  end
