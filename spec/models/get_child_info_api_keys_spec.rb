...
# Unit tests for BrevoApiV3Sdk::GetChildInfoApiKeys
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildInfoApiKeys' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetChildInfoApiKeys.new
  end
  ...
  describe 'test an instance of GetChildInfoApiKeys' do
    it 'should create an instance of GetChildInfoApiKeys' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetChildInfoApiKeys)
    end
  end
