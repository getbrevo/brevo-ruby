# BrevoApiV3Sdk::TransactionalEmailsApi
...
api_instance = BrevoApiV3Sdk::TransactionalEmailsApi.new

block_domain = BrevoApiV3Sdk::BlockDomain.new # BlockDomain | 
...
smtp_template = BrevoApiV3Sdk::CreateSmtpTemplate.new # CreateSmtpTemplate | values to update in transactional email template
...
opts = { 
  delete_hardbounces: BrevoApiV3Sdk::DeleteHardbounces.new # DeleteHardbounces | values to delete hardbounces
}
...
send_test_email = BrevoApiV3Sdk::SendTestEmail.new # SendTestEmail | 
...
send_smtp_email = BrevoApiV3Sdk::SendSmtpEmail.new # SendSmtpEmail | Values to send a transactional email
...
smtp_template = BrevoApiV3Sdk::UpdateSmtpTemplate.new # UpdateSmtpTemplate | values to update in transactional email template
