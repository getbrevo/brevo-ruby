...
# Unit tests for BrevoApiV3Sdk::GetWhatsappCampaignsCampaigns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWhatsappCampaignsCampaigns' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetWhatsappCampaignsCampaigns.new
  end
  ...
  describe 'test an instance of GetWhatsappCampaignsCampaigns' do
    it 'should create an instance of GetWhatsappCampaignsCampaigns' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetWhatsappCampaignsCampaigns)
    end
  end
