...
module BrevoApiV3Sdk
  class DomainsApi
    ...
    def get_domainonfiguration(domain_name, opts = {})
      data, _status_code, _headers = get_domainonfiguration_with_http_info(domain_name, opts)
      data
    end
    ...
    # @param domain_name Domain name
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDomainonfigurationModel, Fixnum, Hash)>] GetDomainonfigurationModel data, response status code and response headers
    def get_domainonfiguration_with_http_info(domain_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.get_domainonfiguration ...'
      end
      # verify the required parameter 'domain_name' is set
      if @api_client.config.client_side_validation && domain_name.nil?
        fail ArgumentError, "Missing the required parameter 'domain_name' when calling DomainsApi.get_domainonfiguration"
      end
      # resource path
      local_var_path = '/senders/domains/{domainName}'.sub('{' + 'domainName' + '}', domain_name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetDomainonfigurationModel')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainsApi#get_domainonfiguration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
