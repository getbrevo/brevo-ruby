...
# Unit tests for BrevoApiV3Sdk::GetSmsEventReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsEventReport' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetSmsEventReport.new
  end
  ...
  describe 'test an instance of GetSmsEventReport' do
    it 'should create an instance of GetSmsEventReport' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetSmsEventReport)
    end
  end
