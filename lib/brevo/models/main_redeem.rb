...
module Brevo
  class MainRedeem
    ...
    attr_accessor :reward_attribution_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'debitTransactionId')
        self.debit_transaction_id = attributes[:'debitTransactionId']
      end
      ...
      if attributes.has_key?(:'rewardAttributionId')
        self.reward_attribution_id = attributes[:'rewardAttributionId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reward_attribution_id == o.reward_attribution_id &&
          status == o.status &&
    ...
    def hash
      [cancelled_at, completed_at, contact_id, created_at, debit_transaction_id, expires_at, id, loyalty_program_id, meta, reject_reason, rejected_at, reward_attribution_id, status, updated_at].hash
    end
