...
# Unit tests for BrevoApiV3Sdk::GetTransacAggregatedSmsReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacAggregatedSmsReport' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacAggregatedSmsReport.new
  end
  ...
  describe 'test an instance of GetTransacAggregatedSmsReport' do
    it 'should create an instance of GetTransacAggregatedSmsReport' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacAggregatedSmsReport)
    end
  end
