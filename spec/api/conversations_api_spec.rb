...
# Unit tests for BrevoApiV3Sdk::ConversationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConversationsApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::ConversationsApi.new
  end
  ...
  describe 'test an instance of ConversationsApi' do
    it 'should create an instance of ConversationsApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::ConversationsApi)
    end
  end
