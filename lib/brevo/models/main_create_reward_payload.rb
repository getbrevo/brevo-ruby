...
module Brevo
  class MainCreateRewardPayload
    ...
    def list_invalid_properties
      ...
      if !@public_description.nil? && @public_description.to_s.length > 128
        invalid_properties.push('invalid value for "public_description", the character length must be smaller than or equal to 128.')
      end

      if !@public_name.nil? && @public_name.to_s.length > 128
        invalid_properties.push('invalid value for "public_name", the character length must be smaller than or equal to 128.')
      end
    ...
    def valid?
      ...
      return false if !@public_description.nil? && @public_description.to_s.length > 128
      return false if !@public_name.nil? && @public_name.to_s.length > 128
      true
    end
    ...
    def public_description=(public_description)
      if !public_description.nil? && public_description.to_s.length > 128
        fail ArgumentError, 'invalid value for "public_description", the character length must be smaller than or equal to 128.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] public_name Value to be assigned
    def public_name=(public_name)
      if !public_name.nil? && public_name.to_s.length > 128
        fail ArgumentError, 'invalid value for "public_name", the character length must be smaller than or equal to 128.'
      end
    ...
    def hash
      [name, public_description, public_image, public_name].hash
    end
