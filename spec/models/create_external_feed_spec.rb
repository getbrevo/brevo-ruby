...
# Unit tests for BrevoApiV3Sdk::CreateExternalFeed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateExternalFeed' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateExternalFeed.new
  end
  ...
  describe 'test an instance of CreateExternalFeed' do
    it 'should create an instance of CreateExternalFeed' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateExternalFeed)
    end
  end
