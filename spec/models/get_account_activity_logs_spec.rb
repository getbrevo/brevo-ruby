...
# Unit tests for BrevoApiV3Sdk::GetAccountActivityLogs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccountActivityLogs' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetAccountActivityLogs.new
  end
  ...
  describe 'test an instance of GetAccountActivityLogs' do
    it 'should create an instance of GetAccountActivityLogs' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetAccountActivityLogs)
    end
  end
