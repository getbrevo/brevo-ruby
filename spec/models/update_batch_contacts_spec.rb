...
# Unit tests for BrevoApiV3Sdk::UpdateBatchContacts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateBatchContacts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateBatchContacts.new
  end
  ...
  describe 'test an instance of UpdateBatchContacts' do
    it 'should create an instance of UpdateBatchContacts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateBatchContacts)
    end
  end
