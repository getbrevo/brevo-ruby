...
# Unit tests for BrevoApiV3Sdk::RemoveContactFromList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemoveContactFromList' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::RemoveContactFromList.new
  end
  ...
  describe 'test an instance of RemoveContactFromList' do
    it 'should create an instance of RemoveContactFromList' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::RemoveContactFromList)
    end
  end
