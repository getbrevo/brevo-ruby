...
# Unit tests for BrevoApiV3Sdk::GetWhatsappEventReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWhatsappEventReport' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetWhatsappEventReport.new
  end
  ...
  describe 'test an instance of GetWhatsappEventReport' do
    it 'should create an instance of GetWhatsappEventReport' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetWhatsappEventReport)
    end
  end
