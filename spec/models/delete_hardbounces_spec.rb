...
# Unit tests for BrevoApiV3Sdk::DeleteHardbounces
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteHardbounces' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::DeleteHardbounces.new
  end
  ...
  describe 'test an instance of DeleteHardbounces' do
    it 'should create an instance of DeleteHardbounces' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::DeleteHardbounces)
    end
  end
