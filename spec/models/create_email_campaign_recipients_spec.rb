...
# Unit tests for BrevoApiV3Sdk::CreateEmailCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmailCampaignRecipients' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateEmailCampaignRecipients.new
  end
  ...
  describe 'test an instance of CreateEmailCampaignRecipients' do
    it 'should create an instance of CreateEmailCampaignRecipients' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateEmailCampaignRecipients)
    end
  end
