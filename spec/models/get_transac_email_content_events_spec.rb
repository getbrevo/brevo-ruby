...
# Unit tests for BrevoApiV3Sdk::GetTransacEmailContentEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacEmailContentEvents' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacEmailContentEvents.new
  end
  ...
  describe 'test an instance of GetTransacEmailContentEvents' do
    it 'should create an instance of GetTransacEmailContentEvents' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacEmailContentEvents)
    end
  end
