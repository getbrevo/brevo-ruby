...
# Unit tests for BrevoApiV3Sdk::UploadImageToGallery
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadImageToGallery' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UploadImageToGallery.new
  end
  ...
  describe 'test an instance of UploadImageToGallery' do
    it 'should create an instance of UploadImageToGallery' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UploadImageToGallery)
    end
  end
