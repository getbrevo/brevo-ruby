...
# Unit tests for BrevoApiV3Sdk::ConversationsMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConversationsMessage' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::ConversationsMessage.new
  end
  ...
  describe 'test an instance of ConversationsMessage' do
    it 'should create an instance of ConversationsMessage' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::ConversationsMessage)
    end
  end
