...
# Unit tests for BrevoApiV3Sdk::GetReportsReports
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsReports' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetReportsReports.new
  end
  ...
  describe 'test an instance of GetReportsReports' do
    it 'should create an instance of GetReportsReports' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetReportsReports)
    end
  end
