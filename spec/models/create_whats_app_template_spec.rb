...
# Unit tests for BrevoApiV3Sdk::CreateWhatsAppTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateWhatsAppTemplate' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateWhatsAppTemplate.new
  end
  ...
  describe 'test an instance of CreateWhatsAppTemplate' do
    it 'should create an instance of CreateWhatsAppTemplate' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateWhatsAppTemplate)
    end
  end
