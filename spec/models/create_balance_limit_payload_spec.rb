...
# Unit tests for Brevo::CreateBalanceLimitPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateBalanceLimitPayload' do
  before do
    # run before each test
    @instance = Brevo::CreateBalanceLimitPayload.new
  end
  ...
  describe 'test an instance of CreateBalanceLimitPayload' do
    it 'should create an instance of CreateBalanceLimitPayload' do
      expect(@instance).to be_instance_of(Brevo::CreateBalanceLimitPayload)
    end
  end
