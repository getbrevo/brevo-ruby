...
# Unit tests for BrevoApiV3Sdk::CreateWhatsAppCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateWhatsAppCampaignRecipients' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateWhatsAppCampaignRecipients.new
  end
  ...
  describe 'test an instance of CreateWhatsAppCampaignRecipients' do
    it 'should create an instance of CreateWhatsAppCampaignRecipients' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateWhatsAppCampaignRecipients)
    end
  end
