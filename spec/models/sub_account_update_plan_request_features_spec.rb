...
# Unit tests for BrevoApiV3Sdk::SubAccountUpdatePlanRequestFeatures
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountUpdatePlanRequestFeatures' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::SubAccountUpdatePlanRequestFeatures.new
  end
  ...
  describe 'test an instance of SubAccountUpdatePlanRequestFeatures' do
    it 'should create an instance of SubAccountUpdatePlanRequestFeatures' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::SubAccountUpdatePlanRequestFeatures)
    end
  end
