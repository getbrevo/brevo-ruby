...
module Brevo
  class MainLimit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rewardLimitId')
        self.reward_limit_id = attributes[:'rewardLimitId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reward_limit_id == o.reward_limit_id &&
    ...
    def hash
      [created_at, duration_unit, duration_value, limit_value, reward_limit_id, sliding_schedule, type, updated_at].hash
    end
