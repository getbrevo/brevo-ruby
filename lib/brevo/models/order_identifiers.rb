...
module Brevo
  ...
  class OrderIdentifiers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loyalty_subscription_id')
        self.loyalty_subscription_id = attributes[:'loyalty_subscription_id']
      end
    ...
    def hash
      [ext_id, loyalty_subscription_id, phone_id, email_id].hash
    end
