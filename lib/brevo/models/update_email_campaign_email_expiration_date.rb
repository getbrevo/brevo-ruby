...
module Brevo
  ...
  class UpdateEmailCampaignEmailExpirationDate
    ...
    def list_invalid_properties
      ...
      if !@duration.nil? && @duration > 3600
        invalid_properties.push('invalid value for "duration", must be smaller than or equal to 3600.')
      end
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('String', ['days', 'weeks', 'months'])
    ...
    def duration=(duration)
      if !duration.nil? && duration > 3600
        fail ArgumentError, 'invalid value for "duration", must be smaller than or equal to 3600.'
      end
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ['days', 'weeks', 'months'])
