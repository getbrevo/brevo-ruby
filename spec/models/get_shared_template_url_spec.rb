...
# Unit tests for BrevoApiV3Sdk::GetSharedTemplateUrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSharedTemplateUrl' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetSharedTemplateUrl.new
  end
  ...
  describe 'test an instance of GetSharedTemplateUrl' do
    it 'should create an instance of GetSharedTemplateUrl' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetSharedTemplateUrl)
    end
  end
