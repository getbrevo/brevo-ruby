...
module Brevo
  class ConversionSourceMetrics
    ...
    def valid?
      ...
      conversion_source_validator = EnumAttributeValidator.new('String', ['email_campaign', 'sms_campaign', 'automation_workflow_email', 'automation_workflow_sms'])
    ...
    def conversion_source=(conversion_source)
      validator = EnumAttributeValidator.new('String', ['email_campaign', 'sms_campaign', 'automation_workflow_email', 'automation_workflow_sms'])
