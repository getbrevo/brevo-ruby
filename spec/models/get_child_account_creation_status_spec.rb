...
# Unit tests for BrevoApiV3Sdk::GetChildAccountCreationStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildAccountCreationStatus' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetChildAccountCreationStatus.new
  end
  ...
  describe 'test an instance of GetChildAccountCreationStatus' do
    it 'should create an instance of GetChildAccountCreationStatus' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetChildAccountCreationStatus)
    end
  end
