...
# Unit tests for BrevoApiV3Sdk::GetProductDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetProductDetails' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetProductDetails.new
  end
  ...
  describe 'test an instance of GetProductDetails' do
    it 'should create an instance of GetProductDetails' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetProductDetails)
    end
  end
