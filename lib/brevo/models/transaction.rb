...
module Brevo
  ...
  class Transaction
    ...
    def hash
      [amount, balance_definition_id, cancelled_at, completed_at, contact_id, created_at, event_time, expiration_date, id, loyalty_program_id, meta, reject_reason, rejected_at, status, updated_at].hash
    end
