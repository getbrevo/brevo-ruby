...
# Unit tests for BrevoApiV3Sdk::UpdateExternalFeed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateExternalFeed' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::UpdateExternalFeed.new
  end
  ...
  describe 'test an instance of UpdateExternalFeed' do
    it 'should create an instance of UpdateExternalFeed' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::UpdateExternalFeed)
    end
  end
