...
# Unit tests for BrevoApiV3Sdk::GetAccountActivity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccountActivity' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetAccountActivity.new
  end
  ...
  describe 'test an instance of GetAccountActivity' do
    it 'should create an instance of GetAccountActivity' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetAccountActivity)
    end
  end
