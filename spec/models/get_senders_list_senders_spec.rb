...
# Unit tests for BrevoApiV3Sdk::GetSendersListSenders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSendersListSenders' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetSendersListSenders.new
  end
  ...
  describe 'test an instance of GetSendersListSenders' do
    it 'should create an instance of GetSendersListSenders' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetSendersListSenders)
    end
  end
