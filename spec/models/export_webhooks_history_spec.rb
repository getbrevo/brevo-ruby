...
# Unit tests for BrevoApiV3Sdk::ExportWebhooksHistory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExportWebhooksHistory' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::ExportWebhooksHistory.new
  end
  ...
  describe 'test an instance of ExportWebhooksHistory' do
    it 'should create an instance of ExportWebhooksHistory' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::ExportWebhooksHistory)
    end
  end
