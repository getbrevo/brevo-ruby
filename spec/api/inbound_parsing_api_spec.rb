...
# Unit tests for BrevoApiV3Sdk::InboundParsingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundParsingApi' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::InboundParsingApi.new
  end
  ...
  describe 'test an instance of InboundParsingApi' do
    it 'should create an instance of InboundParsingApi' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::InboundParsingApi)
    end
  end
