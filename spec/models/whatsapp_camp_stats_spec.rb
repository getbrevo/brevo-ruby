...
# Unit tests for BrevoApiV3Sdk::WhatsappCampStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WhatsappCampStats' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::WhatsappCampStats.new
  end
  ...
  describe 'test an instance of WhatsappCampStats' do
    it 'should create an instance of WhatsappCampStats' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::WhatsappCampStats)
    end
  end
