...
module Brevo
  class CorporateGroupDetailsResponse
    ...
    def self.swagger_types
      {
        ...
        :'sub_accounts' => :'Array<CorporateGroupDetailsResponseSubaccounts>',
        :'users' => :'Array<CorporateGroupDetailsResponseUsers>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sub-accounts')
        if (value = attributes[:'sub-accounts']).is_a?(Array)
