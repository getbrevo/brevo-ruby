...
# Unit tests for BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription)
    end
  end
