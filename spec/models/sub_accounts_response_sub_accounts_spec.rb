...
# Unit tests for BrevoApiV3Sdk::SubAccountsResponseSubAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountsResponseSubAccounts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::SubAccountsResponseSubAccounts.new
  end
  ...
  describe 'test an instance of SubAccountsResponseSubAccounts' do
    it 'should create an instance of SubAccountsResponseSubAccounts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::SubAccountsResponseSubAccounts)
    end
  end
