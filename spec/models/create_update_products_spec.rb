...
# Unit tests for BrevoApiV3Sdk::CreateUpdateProducts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUpdateProducts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateUpdateProducts.new
  end
  ...
  describe 'test an instance of CreateUpdateProducts' do
    it 'should create an instance of CreateUpdateProducts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateUpdateProducts)
    end
  end
