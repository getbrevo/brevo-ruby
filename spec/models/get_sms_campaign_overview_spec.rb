...
# Unit tests for BrevoApiV3Sdk::GetSmsCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsCampaignOverview' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetSmsCampaignOverview.new
  end
  ...
  describe 'test an instance of GetSmsCampaignOverview' do
    it 'should create an instance of GetSmsCampaignOverview' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetSmsCampaignOverview)
    end
  end
