...
# Unit tests for BrevoApiV3Sdk::GetTransacBlockedContacts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacBlockedContacts' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetTransacBlockedContacts.new
  end
  ...
  describe 'test an instance of GetTransacBlockedContacts' do
    it 'should create an instance of GetTransacBlockedContacts' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetTransacBlockedContacts)
    end
  end
