...
# Unit tests for BrevoApiV3Sdk::GetEmailCampaigns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailCampaigns' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetEmailCampaigns.new
  end
  ...
  describe 'test an instance of GetEmailCampaigns' do
    it 'should create an instance of GetEmailCampaigns' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetEmailCampaigns)
    end
  end
