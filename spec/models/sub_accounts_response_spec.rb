...
# Unit tests for BrevoApiV3Sdk::SubAccountsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountsResponse' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::SubAccountsResponse.new
  end
  ...
  describe 'test an instance of SubAccountsResponse' do
    it 'should create an instance of SubAccountsResponse' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::SubAccountsResponse)
    end
  end
