...
# Unit tests for BrevoApiV3Sdk::RequestContactImportNewList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestContactImportNewList' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::RequestContactImportNewList.new
  end
  ...
  describe 'test an instance of RequestContactImportNewList' do
    it 'should create an instance of RequestContactImportNewList' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::RequestContactImportNewList)
    end
  end
