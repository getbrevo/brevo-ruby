...
# Unit tests for BrevoApiV3Sdk::GetStatsByDevice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetStatsByDevice' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::GetStatsByDevice.new
  end
  ...
  describe 'test an instance of GetStatsByDevice' do
    it 'should create an instance of GetStatsByDevice' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::GetStatsByDevice)
    end
  end
