...
# Unit tests for BrevoApiV3Sdk::CreateEmailCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmailCampaign' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::CreateEmailCampaign.new
  end
  ...
  describe 'test an instance of CreateEmailCampaign' do
    it 'should create an instance of CreateEmailCampaign' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::CreateEmailCampaign)
    end
  end
