...
# Unit tests for BrevoApiV3Sdk::AddContactToList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddContactToList' do
  before do
    # run before each test
    @instance = BrevoApiV3Sdk::AddContactToList.new
  end
  ...
  describe 'test an instance of AddContactToList' do
    it 'should create an instance of AddContactToList' do
      expect(@instance).to be_instance_of(BrevoApiV3Sdk::AddContactToList)
    end
  end
